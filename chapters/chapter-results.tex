...
\subsection{\textit{Smart Watch}}

%dizer a escolha do BPM em vez de HRV

%dizer a escolha do MQTT em vez de BLE. Dizer que a descoberta do broker local é via código de emparelhamento

%dizer como funciona

\subsection{Periféricos}

%frase introdutória a relembrar que os periféricos foram escolhidos pelo seu valor demonstrativo, não necessariamente por serem os mais usados
%frase introdutória a explicar que é importante detalhar os métodos de recolha e as considerações de privacidade

\subsubsection{Câmara}

%dizer que métricas utilizei

%explicar o processamento para formato e porque coloquei logo métricas

\subsubsection{Teclado}

%explicar porque é que dar as keys raw é mau, e dizer que não precisamos de saber a tecla específica apenas o tipo de tecla

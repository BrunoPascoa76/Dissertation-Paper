...
A matriz apresentada na Tabela~\ref{tab:validacao_fr} estabelece a correspondência direta entre cada requisito funcional e o componente ou mecanismo implementado na solução final
...
\subsection{Qualidade por design}

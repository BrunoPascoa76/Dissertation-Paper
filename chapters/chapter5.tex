...
Ao longo e após o desenvolvimento da solução, foi também realizada a validação para garantir que todos os requisitos definidos na Secção~\ref{sec:requirements} foram cumpridos \ref{fr:1}
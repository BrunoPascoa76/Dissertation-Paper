...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Broker MQTT local:} Este broker \ac{MQTT} (nativo do próprio python) servirá para comunicação entre a app e o smartwatch, permitindo o envio de comandos e a troca de informação entre estes.
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item \textbf{Kafka REST Proxy:} Adaptador que permite o acesso ao Kafka através duma interface \ac{REST} para dispostivos (como o smartwatch) que não consigam utilizar a interface nativa do Kafka.
        \end{itemize}

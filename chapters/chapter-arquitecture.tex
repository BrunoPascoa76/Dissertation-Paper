...
Com base nos objetivos descritos na Secção~\ref{sec:objectives}, foram estabelecidos os seguintes requisitos para o sistema:
\begin{itemize}
    \item Suporte para recolha de dados de múltiplos utilizadores em simultâneo, o que suporta arquiteturas que separem o sistema em componentes locais e remotos, como a arquitetura cliente-servidor.
    \item Suporte para o uso de múltiplos periféricos nativos do computador e dispositivos \textit{wearable off-the-shelf}, o que favorece o controlo e agregação local dos dados no computador do utilizador, visto que os periféricos e muitos dos dispositivos \textit{wearables} são incapazes de comunicar diretamente com um servidor remoto.
    \item O sistema tem de possuir baixo acoplamento para reduzir e localizar o esforço de acoplamento, o que implica o uso de uma arquitetura de \textit{plug-ins} ou microsserviços e uma preferência por manter o servidor agnóstico ao tipo de sensor (sendo, por isso, apenas necessário alterar o sistema).
\end{itemize}

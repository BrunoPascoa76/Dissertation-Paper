...
\TitlePT{Infraestrutura Modular de Recolha de Dados de Sensor em Streaming Centrada no Utilizador}
...
\Abstract{palavras-chave}{programação, streaming, modular, Kafka, InfluxDB, MQTT, sensores, processamento de dados}
         ...
         \newline Esta dissertação propõe o desenho e implementação de uma infraestrutura modular, extensível e agnóstica ao conteúdo dos dados, baseados numa arquitetura de processamento em \textit{streaming}. O sistema desenvolvido tira partido do protocolo MQTT para captação de dados localmente, do ecossistema Apache Kafka para orquestração e transporte de dados e do InfluxDB como base de dados de série temporal InfluxDB para persistência.}
